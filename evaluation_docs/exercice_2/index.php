...
if(isset($_GET['order']) && isset($_GET['column']))
{
	...
	if($_GET['lastname'] == 'lastname')
	{
		$order = ksort('lastname'); 
	}
	elseif($_GET['firstname'] == 'firstname')
	{
		$order = ksort ('firstname');
	}
	
	elseif($_GET['birthdate'] == 'birthdate')
	{
		$order = krsort('birthdate');
	}
